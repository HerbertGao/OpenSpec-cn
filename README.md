<p align="center">
  <a href="https://github.com/HerbertGao/OpenSpec-cn">
    <picture>
...
<p align="center">
  <a href="https://github.com/HerbertGao/OpenSpec-cn/actions/workflows/ci.yml"><img alt="CI" src="https://github.com/HerbertGao/OpenSpec-cn/actions/workflows/ci.yml/badge.svg" /></a>
  <a href="https://www.npmjs.com/package/@herbertgao/openspec-cn"><img alt="npm version" src="https://img.shields.io/npm/v/@herbertgao/openspec-cn?style=flat-square" /></a>
...
[![Stars](https://img.shields.io/github/stars/HerbertGao/OpenSpec-cn?style=flat-square&label=Stars)](https://github.com/HerbertGao/OpenSpec-cn/stargazers)
[![Downloads](https://img.shields.io/npm/dm/@herbertgao/openspec-cn?style=flat-square&label=Downloads/mo)](https://www.npmjs.com/package/@herbertgao/openspec-cn)
[![Contributors](https://img.shields.io/github/contributors/HerbertGao/OpenSpec-cn?style=flat-square&label=Contributors)](https://github.com/HerbertGao/OpenSpec-cn/graphs/contributors)
...
> [!NOTE]
> 命令仍是 `openspec-cn`；免安装可用 `npx @herbertgao/openspec-cn init`。
